...
namespace Christoc.Modules.SQLWorldDBv1
{
    ...
    /// 
    /// Because the control inherits from SQLWorldDBv1SettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : SQLWorldDBv1ModuleSettingsBase
    {
